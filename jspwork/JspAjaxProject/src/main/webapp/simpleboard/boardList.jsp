...
<body>
	...
	int perBlock = 3; //한블럭당 보여질 페이지 갯수
	...
	for(simpleBoardDto dto:list) {
		...
		//댓글 변수에 댓글 총 갯수 넣기
		int acount = adao.getAllData(dto.getNum()).size();
  ...
  <div style="margin: 50px 100px; width: 800px;">
    <button type="button" class="btn btn-outline-info" onclick="location.href='addForm.jsp'" style="margin-left: 700px;">
