	...
	<table class="table table-bordered" style="width: 600px;">
	  ...
	  <tr>
	    <td>
	      ...
	      onclick="location.href='form?num=${dto.num}&regroup=${dto.regroup }&restep=${dto.restep }
	      &relevel=${dto.relevel }&currentPage=${currentPage }'">답글</button>
