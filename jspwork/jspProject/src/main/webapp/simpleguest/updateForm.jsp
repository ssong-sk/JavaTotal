    ...
    <table class="table table-bordered" style="width: 550px;">
      ...
      <tr>
        ...
        <td>
          ...
          class="from-control" style="width: 120px" value="<%=dto.getNickname()%>">
        </td>
      ...
      <tr>
        ...
        <td colspan="4">
          <%
            for(int i = 1; i <=10; i++) {
             int n = Integer.parseInt(dto.getImage()); //dto는 db에 저장된 값을 int값으로 형 변환해서 가져오기
            %>
            	<input type="radio"  value="<%=i%>" <%=i==n?"checked":"" %> 
      ...
      <tr>
        <td colspan="4">
          <textarea style="width: 550px; height: 100px;" name="content" class="form-control"><%=dto.getContent() %></textarea>
        </td>
      </tr>
