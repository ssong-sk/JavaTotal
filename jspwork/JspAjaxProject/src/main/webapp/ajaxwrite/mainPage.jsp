        ...
        <caption align="top"><b>글쓰기</b></caption>
          ...
          <tr>
            <th width="100" class="table-warning">작성자</th>
              <td>
                <input type="text" name="writer" id="writer" class="form-control" required="required"
                style="width: 130px;">
              </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              <textarea style="width: 300px; height: 100px;" name="story" id="story"
          ...
          <tr>
            ...
            <td>
              ...
              <select id="selimage" style="width: 100px;" class="form-control">
                ...
                <option value="../image/avata/b6.png">좌절함</option>
          ...
          <tr>
            <td colspan="2" align="center">
              <button type="button" class="btn btn-outline-success" id="btninsert">DB추가</button>
            </td>
          </tr>
      ...
      <tr>
        <td>
          ...
          onclick="location.href='mainPage.jsp'">목록</button>
           ...
           <button type="button" class="addbtn btn btn-outline-success btn-sm">글쓰기</button>
