    ...
    <form action="update" method="post">
      ...
      <table class="table table-bordered">
        ...
        <tr>
          <th>상품명</th>
          <td>
            <input type="text" name="sangname" class="form-control" style="width: 150px;" 
            required="required" value="${dto.sangname }">
          </td>
        </tr>
        ...
        <tr>
          <th>상품가격</th>
          <td>
            <input type="text" name="sangprice" class="form-control" style="width: 150px;" 
            required="required" value="${dto.sangprice }">
          </td>
        </tr>
