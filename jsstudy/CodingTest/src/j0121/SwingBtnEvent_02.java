...
public class SwingBtnEvent_02 extends JFrame implements ActionListener { // 0118_05
	...
	// 2.메서드 형성(상속)
	public SwingBtnEvent_02(String title) {
		super(title);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(ob == btn1) {
			JOptionPane.showMessageDialog(this, "왼쪽 별");
		}
		else if(ob == btn2) {
			JOptionPane.showMessageDialog(this, "오른쪽 별");
		}
	...
	public static void main(String[] args) {
		...
		new SwingBtnEvent_02("스윙 버튼 이벤트");
