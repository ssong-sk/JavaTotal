...
<div style="margin:30px 50px">
  ...
  <table class="table table-bordered" style="width:1000px;">
    ...
    <%}
      ...
      <tr>
        ...
        <td><button type="button" class="btn btn-info" onclick="loction.href='detailPage.jsp?num<%=dto.getNum()%>'">자세히보기</button></td>
      </tr>
     <%}
    %>
  ...
  <button  type="button" class="btn btn-info" style="width: 100px" onclick="locaction.href='addForm.jsp'">추가폼</button>
</div>
